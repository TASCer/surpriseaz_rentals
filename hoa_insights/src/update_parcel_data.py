	...
	for parcel_details in latest_data:
		...
		try:
			with engine.connect() as conn, conn.begin():
				insert_qry = (f"INSERT INTO hoa_insights.{PARCEL_OWNERS} (APN, OWNER, MAIL_ADX, RENTAL, SALE_DATE, SALE_PRICE, DEED_DATE, DEED_TYPE, LEGAL_CODE) "
		...
		if is_rental:
			...
			rental_owner_address: str = parcel_details['RentalInformation']['OwnerAddress']
			...
			if isinstance(rental_owner_name, str):
				...
				rental_owner_name: str = parcel_details['RentalInformation']['OwnerName']['Name']
				rental_owner_name: str = rental_owner_name.replace(',', ' ')

			if parcel_details['RentalInformation']['AgentName']:
				rental_contact_name: str = parcel_details['RentalInformation']['AgentName']
				rental_contact_name: str = rental_contact_name.replace(',', '')
				rental_contact_address: str = parcel_details['RentalInformation']['AgentAddress']
				...
				rental_contact_name: str = parcel_details['RentalInformation']['BusinessContactName']
				rental_contact_name = rental_contact_name.replace(',', '')
				rental_contact_address: str = parcel_details['RentalInformation']['BusinessContactAddress']
				rental_contact_address: str = rental_contact_address.replace(',', '')
